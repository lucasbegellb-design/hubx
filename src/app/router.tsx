...
export const router = createHashRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "aujourdhui", lazy: async () => ({ Component: (await import("@/features/aujourdhui/PageAujourdhui")).default }) },
      ...
      { path: "process/:id", lazy: async () => ({ Component: (await import("@/features/process/PageProcessDetail")).default }) },
      { path: "chine", lazy: async () => ({ Component: (await import("@/features/chine/PageChine")).default }) },
      { path: "documents", lazy: async () => ({ Component: (await import("@/features/documents/PageDocuments")).default }) },
      { path: "rapports", lazy: async () => ({ Component: (await import("@/features/rapports/PageRapports")).default }) },
      { path: "parametres", lazy: async () => ({ Component: (await import("@/features/parametres/PageParametres")).default }) },
